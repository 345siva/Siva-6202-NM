...
export default function Hero() {
  const config ={
    ...
    social:{
    github:"https://github.com/345siva/siva",
    whatsapp:"https://wa.me/7358809252/",
    instagram:"https://www.instagram.com/siva_siva_5511?igsh=MTZneGkxeWpucHptNw=="
    } 
    ...
    return <section className='flex flex-col  md:flex-row px-5 py-32  bg-secondary justify-center ' id='hero'>
        <div className=' md:  w-1/2 flex flex-col'>
            <h1 className=' text-white text-4xl font hero-font '>Hi,<br/> i am M Siva
